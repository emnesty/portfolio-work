  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-lg font-medium">{t('selectedProjects')}</h3>
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-3 text-lg font-medium">{t('cases')}</h3>
          ...
          >
            {CASES.map((caseStudy) => (
              <Link
                ...
                href={caseStudy.link[locale]}
                data-id={caseStudy.uid}
              >
